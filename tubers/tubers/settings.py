...
SECRET_KEY = ')@j0!$nn39yn9y_l()yx^ju=9y&&qg=0lk!%fm7_b4axd(=3ju'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.custom-context-processor.subject_renderer',
                'youtubers.youtuber-context-processor.subject_renderer',
                'youtubers.ytmsg_cp.subject_renderer',
